...
function AboutMe() {
  return (
    <>
      <SEO
        title="About Shreya Varma | Clinical Psychologist, South Delhi"
        description="Learn about Shreya Varma's professional journey, education, clinical psychology training, registration, and professional affiliations."
        path="/about"
      />
