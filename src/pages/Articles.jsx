...
function Articles() {
  return (
    <>
      <SEO
        title="Articles & Writings | Shreya Varma"
        description="Selected writings and reflections on psychoanalysis, mental health, and contemporary issues by Shreya Varma."
        path="/articles"
      />
