...
function Services() {
  return (
    <>
      <SEO
        title="Psychological Services | Shreya Varma, South Delhi"
        description="Psychotherapy, consultations, psychological assessments, and clinical supervision offered by Shreya Varma, Clinical Psychologist and Psychoanalytic Psychotherapist in South Delhi."
        path="/services"
      />
        ...
        <div className="grid gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <h2 className="text-xl font-semibold tracking-wide mb-4 mt-2 text-gray-900">
                {service.title}
              </h2>
