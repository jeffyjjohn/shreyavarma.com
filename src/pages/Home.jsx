...
function Home() {
  return (
    <>
      <SEO
        title="Shreya Varma | Clinical Psychologist & Psychoanalytic Psychotherapist, South Delhi"
        description="Licensed Clinical Psychologist and Psychoanalytic Psychotherapist in South Delhi offering psychotherapy, consultations, psychological assessments, and professional supervision."
        path="/"
      />
      ...
      >
        <div className="prose prose-lg max-w-none">
          <h1 className="text-2xl md:text-3xl font-medium tracking-tight text-neutral-800 mb-6">
            Shreya Varma 
          </h1>
